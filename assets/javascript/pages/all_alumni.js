  ...
  handleDataTables: function handleDataTables() {
    return $('#myTable').DataTable({
      ...
      columnDefs: [{
        ...
        targets: 27,
        render: function render(data, type, row, meta) {
          return '<a class="btn btn-sm btn-secondary"  href="edit_u=' + data + '">Edit</a>\n          <a href="#" class="btn drop btn-sm btn-secondary" data-id="' + data + '">Drop</a><a class="btn btn-sm btn-secondary" href="#' + data + '">Clear</a>';
        }
      }, {
        targets: 1,
        render: function render(data, type, row, meta) {
