                    ...
                    <div class="card card-fluid border">
                      ...
                      <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <ul class="nav nav-tabs card-header-tabs">
                          <li class="nav-item">
                            <a class="nav-link active show" data-toggle="tab" href="#tab1">Inventory Report</a>
                          </li>
                        </ul>
                      ...
                      <div class="card-body text-center">
                          <div class="tab-content">
                            <div class="container mx-auto">
                              <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-check form-check-inline" style="padding:30px;">
                                      <p class="mt-2" style="position:relative;top:2px;right:8px;">Year:</p><input type="text" class="form-control form-check-input" name="year" value="<?php echo date('Y');?>">
                                    </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".preview").click(function() {
        ...
        url = "inventory_report_prev.php?year=" + year + "&type=" + type+"&status="+status;
        urlhead = url;
        console.log(url);
