...
<head>
        ...
        <div class="page-inner">
          ...
          <header class="page-title-bar">
            ...
            <div class="d-md-flex align-items-md-start">
              <h1 class="page-title mr-sm-auto text-white"> Masterlist of Inventory Collections</h1>
          ...
          <div class="page-section">
            <header class="card-header" style="background-color: white;border-radius: 0px;border: none;">
              <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                  <a class="nav-link " href="inventory.php" >Books</a>
                </li>
  ...
  <script>
      $(document).ready(function() {
        ...
        function datatables(types) {
          ...
          $('#myTable').DataTable({
            ...
            columns: [
              ...
              { data: 'Author',  className: 'align-middle', searchable: false},
        ...
        $(document).on('change', '#filtertype', function() {
          let type = $(this).val();
          if (type == '0') {
            let inventory_t = "inventory_t";
            datatables(inventory_t);
          } else if (type == '1') {
            let inventory = "inventory_t_e";
            datatables(inventory);
          } else if (type == '2') {
            let inventory = "inventory_t_ne";
            datatables(inventory);
          } else {
            let inventory = "inventory_t_l";
            datatables(inventory);
          }
        ...
        $(document).on('change', '.inventoryhandler', function() {
          let yesno = $(this).val();
          let id = $(this).attr("data-id")+".thesis";
          let year = $("#year").val();
          const type = "Thesis";
          $.ajax({
  ...
  <script src="assets/javascript/pages/inventory_t.js"></script>
