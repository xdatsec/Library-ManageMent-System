                      ...
                      <div class="card card-fluid border">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center"">
                          ...
                          <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                              <a class="nav-link active show" data-toggle="tab" href="#tab1">Collection Status</a>
                            </li>
                          </ul>
                                      ...
                                      <div class="col-sm-10" style="margin:auto;">
                                        <div class="form-group">
                                          ...
                                          <select class="form-control" name="status1" id="status1">
                                              ...
                                              <option value="RE">Replacement</option>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".preview").click(function(){
        ...
        url = "collection_status_prev.php?status="+status+"&start="+begind+"&end="+endd;
          urlhead = url;
          console.log(url);
