              ...
              <div class="page-section">
                ...
                <section class="card card-fluid" id="fullscreenDiv"  style="border-style: solid;border-color:#408080;">
                  ...
                  <header class="card-header">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  id="tab1">Library Member</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link"  id="tab2">Information</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active show"  href="all_members_list.php">List</a>
                      </li>
                      ...
                      <div class="input-group input-group-alt">
                        ...
                        <div class="input-group-prepend">
                          ...
                          <select id="filterBy" class="custom-select">
                            ...
                            <option value="3">MiddleName</option>
...
<script src="assets/javascript/main.min.js"></script>
    ...
    <script src="assets/javascript/pages/all_members.js"></script>
...
<script type="text/javascript" language="javascript" class="init">
  ...
  handleFlatpickr: function handleFlatpickr() {
    ...
    $('#tab1').click(function() {
        ...
        location.reload();
        window.location.href = '/library_members.php';
    });
    $('#tab2').click(function() {
  ...
  jQuery(window).on("load", function () {
    ...
    history.pushState(null, null, '/library_members.php');
  });
