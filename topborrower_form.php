                      ...
                      <div class="card card-fluid border">
                          ...
                          <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <ul class="nav nav-tabs card-header-tabs">
                              <li class="nav-item">
                                <a class="nav-link active show" data-toggle="tab" href="#tab1">Top Borrowers</a>
                              </li>
                            </ul>
                                      ...
                                      <div class="form-group ">
                                        ...
                                        <div class="form-group row" style="padding: 30px;">
                                            <div class="col-sm-10" style="margin:auto;">
                                                <div class="form-group">
                                                    <label for="type">Print By Purpose</label>
                              ...
                              <div class="container mx-auto">
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group ">
                                      <div class="form-group row" style="padding: 30px; border: 1px solid black;">
                                        ...
                                        <div class="col-sm-10" style="margin:auto;">
                                          ...
                                          <center> 
                                            <div style="display: flex; justify-content: center; gap: 10px; align-items: center;display:block;" class="datehandler">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".preview").click(function() {
        ...
        let datefrom1 = new Date($('#datefrom').val());
let dateto1 = new Date($('#dateto').val());
        ...
        if (type == "") {
          ...
          url = "topborrower.php?datefrom=" + datefrom + "&dateto=" + dateto + "&type=" + type;
