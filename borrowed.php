...
<html lang="en">
                ...
                <section id="fullscreenDiv" class="card card-fluid" style="border-style: solid;border-color:#408080;">
                  ...
                  <header class="card-header">
                    ...
                    <ul class="nav nav-tabs card-header-tabs">
                      <li class="nav-item">
                        <a class="nav-link"  href="returned.php" id="tab2">Returned</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active show"  href="borrowed.php">Borrowed</a>
                      </li>
                      ...
                      <div class="input-group input-group-alt">
                        ...
                        <div class="input-group-prepend">
                          <select id="filterBy" class="custom-select">
                            <option value="0">MemberID</option>
                            <option value="1">Name</option>
                            <option value="2">Acession No</option>
                            <option value="3">Copies</option>
                            <option value="4">Title</option>
                            <option value="5">Author</option>
                            <option value="6">Porpose</option>
                            <option value="7">Date Borrowed</option>
                            <option value="8">Due Date</option>
                            <option value="9">Time Borrowed</option>
                            <option value="10">Due Time</option>
                            <option value="11">Remarks</option>
                            <option value="12">CallNum1</option>
                            <option value="13">CallNum2</option>
                            <option value="14">Subject</option>
                            <option value="15">Location</option>
                            <option value="16">Encoder</option>
                            <option value="17">Type</option>
                        ...
                        <div class="input-group has-clearable">
                          ...
                          <input id="table-search" type="text" class="form-control" placeholder="Search Borrowed"> </div>
  ...
  <script src="assets/javascript/main2.js"></script>
    ...
    <script src="assets/javascript/pages/all_borrowed.js"></script>
